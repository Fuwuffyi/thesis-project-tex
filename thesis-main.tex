...
come \texttt{TransformComponent}, \texttt{LightComponent} e \texttt{ParticleSystemComponent}~\ref{lst:scene-management}.
...
\texttt{ResourceHandle} con UID univoci, garantendo riferimenti consistenti senza duplicazioni~\ref{lst:resource-management}.
...
render pass, overhead e utilizzo della CPU. Sono stati impiegati strumenti integrati nel motore (\texttt{GLTimer} e
