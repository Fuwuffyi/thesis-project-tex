...
\lstinputlisting[float,language=C++,label={lst:scene-management}]{listings/scene_management.cpp}
...
\lstinputlisting[float,language=C++,label={lst:resource-management}]{listings/resource_management.cpp}
