...
\begin{figure}[htbp]
   \centering
   \fbox{\includegraphics[width=0.45\linewidth]{figures/performance_overlay.png}}
...
\begin{figure}[htbp]
   \centering
   \fbox{\includegraphics[width=0.45\linewidth]{figures/scene_inspector.png}}
...
\begin{figure}[htbp]
   \centering
   \fbox{\includegraphics[width=0.6\linewidth]{figures/material_editor.png}}
...
\begin{figure}[htbp]
   \centering
   \fbox{\includegraphics[width=0.5\linewidth]{figures/texture_browser.png}}
