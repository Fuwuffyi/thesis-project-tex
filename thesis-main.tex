...
come {\ttfamily TransformComponent}, {\ttfamily LightComponent} e {\ttfamily ParticleSystemComponent}~\ref{lst:scene-management}.
...
di rendering~\ref{lst:scene-update}.
...
{\ttfamily ResourceHandle} con UID univoci, garantendo riferimenti consistenti senza duplicazioni~\ref{lst:resource-management}.
...
l'occupazione di memoria senza compromettere la qualità visiva~\ref{lst:geometry-pass-snippet}.
...
tempo reale tramite l'interfaccia grafica del motore~\ref{lst:lighting-pass-snippet}.
