...
approfondita del comportamento su dispositivi mobile o integrati. Alcune ottimizzazioni specifiche per GPU AMD o Intel
...
l'implementazione di tecniche di global illumination e un sistema di asset streaming,
...
\begin{acknowledgements}
   Desidero ringraziare la \textbf{Prof.ssa~[Damiana Lazzaro]}, relatore della tesi, per la disponibilità, la guida e
