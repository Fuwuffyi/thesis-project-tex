...
la scena, i materiali PBR e le geometrie. Le scene sono caricate dinamicamente secondo la seguente
configurazione:
\begin{table}[h!]
\centering
...
3 & 22 & 0 & Scene completa, massima intensità luminosa \\
...
più architetture hardware, al fine di valutare scalabilità e stabilità delle prestazioni.
\begin{table}[h!]
\centering
\begin{tabular}{l|l|l|l|l}
   \textbf{ID Test} & \textbf{CPU} & \textbf{GPU} & \textbf{VRAM} & \textbf{RAM} \\ \hline
   System A & AMD Ryzen 7 9800X3D & NVIDIA RTX 5080 & 16 GB GDDR7 & 32 GB DDR5 \\
\end{tabular}
