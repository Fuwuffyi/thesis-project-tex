...
l'occupazione di memoria senza compromettere la qualità visiva (Listino ~\ref{lst:geometry-pass-snippet}).
...
Il motore integra sistemi di particelle configurabili tramite {\ttfamily ParticleSystemComponent}.
