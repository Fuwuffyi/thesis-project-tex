...
\texttt{IRenderer}. La gestione delle risorse, inclusi mesh, texture e shader, è centralizzata nel \texttt{ResourceManager},
che utilizza factory specifiche per ciascun backend.
