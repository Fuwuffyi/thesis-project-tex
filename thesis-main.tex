...
\begin{figure}[htbp]
   \centering
   \includegraphics[width=.8\linewidth]{figures/window_screenshot.png}
...
\begin{tabular}{l|l|l|l}
   ...
   E & Intel Core i3-1005G1 & Mesa Intel UHD Graphics (ICL GT1) & X \\ % FuwuffyLaptop
\end{tabular}
...
\begin{figure}[htbp]
   \centering
   \includegraphics[width=.8\linewidth]{figures/heatmap_pc_fps.png}
...
\begin{figure}[htbp]
   \centering
   \includegraphics[width=.8\linewidth]{figures/heatmap_pc_improvements.png}
...
latenza nella preparazione delle draw call, ottenendo frame time più regolari e una minore varianza temporale. Ciò
si traduce in una maggiore stabilità visiva e in un comportamento più prevedibile del motore di rendering.
