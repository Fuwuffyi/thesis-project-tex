...
concorrenza tra CPU e GPU (Fig.\ref{fig:fps-derivation-errorbars}). \\
\begin{figure}[htbp]
   \centering
   \includegraphics[width=.85\linewidth]{figures/fps_derivation_errorbars.png}
   \caption{Derivazione standard degli FPS per scena.}
   \label{fig:fps-derivation-errorbars}
\end{figure}
