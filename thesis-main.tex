...
\begin{figure}[htb!]
    \centering
    \includegraphics[width=.8\linewidth]{figures/uml_scene_renderer.svg}
...
\begin{figure}[htb!]
    \centering
    \includegraphics[width=.8\linewidth]{figures/g_buffer_textures.svg}
...
\begin{figure}[htb!]
    \centering
    \includegraphics[width=.8\linewidth]{figures/uml_resources.svg}
