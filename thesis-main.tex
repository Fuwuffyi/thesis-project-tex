...
\begin{itemize}
    ...
    \item $G(\omega_i,\omega_o,\mathbf{n})$ è il termine di \emph{geometrical attenuation}, che modella \linebreak l'auto-occlusione:
...
{\ttfamily TransformComponent}, {\ttfamily LightComponent} e {\ttfamily ParticleSystem-\\Component}. Ogni nodo può avere figli,
...
come {\ttfamily TransformComponent}, {\ttfamily LightComponent} e {\ttfamily ParticleSystemComponent} (Listing ~\ref{lst:scene-management}).
...
di rendering (Listing ~\ref{lst:scene-update}).
...
{\ttfamily ResourceHandle} con UID univoci, garantendo riferimenti consistenti senza duplicazioni (Listing ~\ref{lst:resource-management}).
...
usando solo due canali (RG), liberando spazio per altri parametri PBR nello stesso G-buffer (Listing ~\ref{lst:geometry-pass-snippet}). \\
...
ridondanti (Listing ~\ref{lst:lighting-pass-snippet}).
...
grazie all'uso di {\ttfamily std::ranges} e operazioni a costo costante dove possibile (Listing~\ref{lst:performance-gui-snippet}). \\
...
\begin{figure}[htbp]
   \centering
   \fbox{\includegraphics[width=0.85\linewidth]{figures/scene_inspector.png}}
...
aggiornamento immediato del rendering grazie al refresh degli uniform buffer (Listing~\ref{lst:material-editor-snippet}). \\
\begin{figure}[htbp]
   \centering
...
Un esempio della compilazione in SPIR-V eseguita dal file CMake viene mostrato nel listing~\ref{lst:spv-compilation}.
...
Per completezza visiva, nella Figura~\ref{fig:scene-samples} sono mostrati alcuni screenshot rappresentativi
dei cinque tipi di scena considerati nei test. \\
\begin{table}[h!]
\centering
...
\begin{figure}[htbp]
    ...
    \begin{subfigure}[b]{0.49\linewidth}
        \includegraphics[width=\linewidth]{figures/screenshot_s0.png}
        \caption{Scena 0}
    \end{subfigure}
    \begin{subfigure}[b]{0.49\linewidth}
        \includegraphics[width=\linewidth]{figures/screenshot_s1.png}
        \caption{Scena 1}
    \end{subfigure}
    % Riga 2
    \begin{subfigure}[b]{0.49\linewidth}
        \includegraphics[width=\linewidth]{figures/screenshot_s2.png}
        \caption{Scena 2}
    \end{subfigure}
    \begin{subfigure}[b]{0.49\linewidth}
        \includegraphics[width=\linewidth]{figures/screenshot_s3.png}
        \caption{Scena 3}
    \end{subfigure}
    % Riga 3
    \begin{subfigure}[b]{0.49\linewidth}
        \includegraphics[width=\linewidth]{figures/screenshot_s4.png}
        \caption{Scena 4}
    \end{subfigure}
    \caption{Esempi di rendering per le cinque scene considerate nei test.}
    \label{fig:scene-samples}
\end{figure}
...
Per fornire una visione dettagliata delle prestazioni, le Figure~\ref{fig:fps-by-hw} mostrano il confronto diretto tra
OpenGL e Vulkan per ciascuna scena, in funzione della configurazione hardware utilizzata. Questi grafici evidenziano
come il vantaggio prestazionale di Vulkan vari significativamente in base alla complessità della scena e alle
caratteristiche dell'hardware. \\
\begin{figure}[htbp]
   \centering
   \includegraphics[width=.8\linewidth]{figures/fps_by_hardware.png}
   \caption{Confronto FPS tra OpenGL e Vulkan su diverse configurazioni hardware.}
   \label{fig:fps-by-hw}
\end{figure}
...
Le Figure~\ref{fig:gain-by-hw} illustrano il guadagno percentuale
...
\begin{figure}[htbp]
   \centering
   \includegraphics[width=.8\linewidth]{figures/gain_by_hardware.png}
   \caption{Guadagno percentuale di Vulkan rispetto a OpenGL.}
   \label{fig:gain-by-hw}
\end{figure}
...
\begin{figure}[htbp]
   ...
   \caption{Stabilità degli FPS per scena.}
...
e della maggiore astrazione offerta dal driver. \\
