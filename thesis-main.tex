...
\begin{figure}
   ...
   \caption{Esempio di g-buffer di deferred rendering da \cite{learnopengl}.}
...
\begin{itemize}
   ...
   \item \textbf{Ambient Occlusion (AO)}: quantifica quanto una superficie è esposta alla luce ambientale.
\end{itemize}
\begin{figure}
   \centering
