...
API, permettendo al resto del sistema di interagire in maniera unificata. \\
...
pipeline di rendering~\ref{fig:uml-scene-renderer}. Le metriche di performance sono raccolte dal modulo
...
frammento della scena. Lo shader scrive nei G-buffer due texture principali~\ref{fig:g-buffer-textures}:
\begin{itemize}
...
scalare le prestazioni con il numero di core disponibili. In OpenGL, invece, la pipeline rimane single-thread,
